...
interface ConfirmClearScheduleModalProps {
  isOpen: boolean;
  date: string;
  clearing: boolean;
  onClose: () => void;
...
export default function ConfirmClearScheduleModal({
  isOpen,
  date,
  clearing,
  onClose,
  onConfirm,
}: ConfirmClearScheduleModalProps) {
  ...
  const modalContent = (
    ...
    >
      ...
      >
        ...
        >
          งานที่จัดไว้จะกลับเป็นสถานะ{" "}
          <span style={{ color: "hsl(var(--foreground))", fontWeight: 600 }}>
            &ldquo;รอดำเนินการ&rdquo;
          </span>{" "}
          ตารางจะถูกล้างทั้งหมด
        </p>
        ...
        >
          ...
          >
            ...
            {clearing ? "กำลังล้าง..." : "ยืนยันล้างตาราง"}
          </button>
        </div>
      </div>
    </div>
